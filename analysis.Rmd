...
- _Respondents with state of origin in the Northeast_ - identifying respondents who are originally from the Northeast (were born or lived there) in order to estimate emigration from that region
...
Year plot of the proportion of respondents in the Southeast state who are not originally from the Southeast
...
#Respondents in the Southeast who were born in the Northeast
...
#Respondents in the whole country who were born outside the state of response and in the Northeast (estimation of emigration from NE)
...
Total who answered not having born in the state of question, and having been born in the NE (question V5030 is only asked for those who answered they were not born in the state where they are answering)
...
Cálculo emigrantes do NE 2010/2015 - para comparar com o artigo https://www.scielo.br/j/rbeur/a/SCVMhkFZ7Hx7d7zwnp56h5q/?format=pdf&lang=pt

Em 2015 não viviam no NE
...
##Table for 2015 (UF in 2015/UF in 2010)
...
table_5080_UF_2015_reg <- table_5080_UF_2015 %>%
  mutate(UF_em_2015 = recode(UF, "11"="RO", "12"="AC", "13"="AM", "14"="RR", "15"="PA", "16"="AP", "17"="TO", "21"="MA", "22"="PI", "23"="CE", "24"="RN", "25"="PB", "26"="PE", "27"="AL", "28"="SE", "29"="BA", "31"="MG", "32"="ES", "33"="RJ", "35"="SP", "41"="PR", "42"="SC", "43"="RS", "50"="MS", "51"="MT", "52"="GO", "53"="DF", "88"="Brasil", "98"="Pais estrangeiro", " "="Nao aplicavel" )) %>%
  mutate(UF_em_2010 = recode(V5080, "11"="RO", "12"="AC", "13"="AM", "14"="RR", "15"="PA", "16"="AP", "17"="TO", "21"="MA", "22"="PI", "23"="CE", "24"="RN", "25"="PB", "26"="PE", "27"="AL", "28"="SE", "29"="BA", "31"="MG", "32"="ES", "33"="RJ", "35"="SP", "41"="PR", "42"="SC", "43"="RS", "50"="MS", "51"="MT", "52"="GO", "53"="DF", "88"="Brasil", "98"="Pais estrangeiro", " "="Nao aplicavel" )) %>%
  mutate(reg_em_2015 = recode(UF, "11"="Norte", "12"="Norte", "13"="Norte", "14"="Norte", "15"="Norte", "16"="Norte", "17"="Norte", "21"="Nordeste", "22"="Nordeste", "23"="Nordeste", "24"="Nordeste", "25"="Nordeste", "26"="Nordeste", "27"="Nordeste", "28"="Nordeste", "29"="Nordeste", "31"="Sudeste", "32"="Sudeste", "33"="Sudeste", "35"="Sudeste", "41"="Sul", "42"="Sul", "43"="Sul", "50"="Centro-Oeste", "51"="Centro-Oeste", "52"="Centro-Oeste", "53"="Centro-Oeste", "88"="Brasil", "98"="Pais estrangeiro", " "="Nao aplicavel" )) %>%
  mutate(reg_em_2010 = recode(V5080, "11"="Norte", "12"="Norte", "13"="Norte", "14"="Norte", "15"="Norte", "16"="Norte", "17"="Norte", "21"="Nordeste", "22"="Nordeste", "23"="Nordeste", "24"="Nordeste", "25"="Nordeste", "26"="Nordeste", "27"="Nordeste", "28"="Nordeste", "29"="Nordeste", "31"="Sudeste", "32"="Sudeste", "33"="Sudeste", "35"="Sudeste", "41"="Sul", "42"="Sul", "43"="Sul", "50"="Centro-Oeste", "51"="Centro-Oeste", "52"="Centro-Oeste", "53"="Centro-Oeste", "88"="Brasil", "98"="Pais estrangeiro", " "="Nao aplicavel" )) %>%
  select(-UF, -V5080)
```

##Table with interegional migration 2010-2015

```{r}
#NOT CORRECT
#intereg_mig_2015 <- table_5080_UF_2015_reg %>%
#                    group_by(reg_em_2010) %>%
#                    summarize(flow = sum(Freq))
...
##Calcuting immigration SE 2010-2015 (from NE)

1996 - 1997 - 1998 - 1999 - 2000 - 2001 - 2002 - 2003 - 2004 - 2005 - 2006 - 2007 - 2008 - 2009 - 2010 - 2011 - 2012 - 2013 - 2014 - 2015
                                                                             |      |     |   x    |__________________h__________________ | 357 132
                                                                             |      |     |______________________________________| y 496 299
                                                                             |      |______________________________________| 451 746
                                                                             |______________________________________| 487 927
...
```{r}
#emigration_NE_2014 <- table_5080_UF_2014 %>%
#  filter(reg_em_2009 == "Nordeste") %>% #filtering respondents who were in NE 5 years before
#  filter(reg_em_2014 != "Nordeste") %>% #filtering respondents who are in any other region #(expcept NE) when answering the survey in 2015
#  summarize(emigration_NE = sum(Freq)) %>% #calculating emigration flow from the NE
#  mutate(period_start = 2009, period_end = 2014) #between 2010 and 2015
```
